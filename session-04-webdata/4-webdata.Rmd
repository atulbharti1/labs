...
```{r}
str_view(stringr::words, "ing$|ise$") #the character "|" is working as an "or" operator here. character "$" seeks those end letter in each word.
```
:::
...
str_view(emails, "[\\w.]+@students\\.hertie-school\\.org" )
